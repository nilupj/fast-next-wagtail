...
export default function DrugsSupplements({ drugsByLetter }) {
  ...
  return (
    <>
      <NextSeo
        title="Drugs & Supplements - HealthInfo"
        ...
        canonical="https://healthinfo.com/drugs-supplements"
      />
          ...
          {alphabet.map((letter) => (
            ...
            >
              ...
              {drugsByLetter[letter] && drugsByLetter[letter].length > 0 ? (
                ...
                <p className="text-neutral-500 italic">No drugs or supplements found starting with this letter.</p>
              )}
            </div>
          ))}
        </div>
